...
import (
	"context"
	"database/sql"
	"databases/repository-patten/models"
...
type UserRepository interface {
	...
	GetUserByEmailWithProfile(email string) (*models.User, error)
...
func (r *SQLUserRepository) GetUserByEmailWithProfile(email string) (*models.User, error) {
	query := `
